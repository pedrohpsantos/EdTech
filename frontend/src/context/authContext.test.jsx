...
const TestComponent = () => {
    ...
    return (
        <div>
            ...
            <button data-testid="btn-login" onClick={() => handleLogin('test@test.com', '123')}>Login</button>
            <button data-testid="btn-logout" onClick={() => handleLogout()}>Logout</button>
            <button data-testid="btn-register" onClick={() => handleRegister({nome: 'Test', email: 'test@test.com', senha: '123', telefone: '123'})}>Register</button>
        </div>
    );
};
