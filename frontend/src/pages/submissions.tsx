      ...
      <div className={styles.statsGrid}>
        ...
        <div className={styles.statCard}>
          ...
          <span className={styles.statValue}>
            {dashboardStats.pendingReview ?? documents.length}
          </span>
        </div>
        <div className={styles.statCard}>
          <div className={styles.statHeader}>
            ...
            {filteredDocuments.map((doc) => (
              <tr key={doc.id}>
                ...
                <td className={styles.projectCell}>
                  {doc.project?.name || 'Projeto não informado'}
                </td>
                ...
                <td>
                  <div className={styles.actionsCell}>
                    <button className={styles.btnAnalisar} onClick={() => handleAnalyze(doc)}>
                      <svg
                        width="16"
                        height="16"
                        fill="none"
            ...
            <div className={styles.modalHeader}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div className={styles.modalSubtitle}>
                  {selectedDoc.author?.name || 'Dr. Renata Silva'} • Análise LGPD • 2.4 MB • enviado
                  Hoje
                </div>
              </div>
            ...
            <div className={styles.modalFooter}>
              ...
              <div style={{ display: 'flex', gap: '1rem' }}>
                <button
                  ...
                  onClick={() => openRejectionModal(selectedDoc)}
                >
                  <svg
                    width="16"
                    height="16"
                    ...
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    style={{ display: 'inline', marginRight: '0.25rem', verticalAlign: 'text-top' }}
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
