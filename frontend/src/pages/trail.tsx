...
const ResearchTrail: React.FC = () => {
    ...
    const documents = [
        { id: '1', title: 'Metodologia_Qualitativa_v3.pdf', project: 'Análise LGPD', status: 'Aprovado' },
        { id: '2', title: 'Dataset_Experimento_A.csv', project: 'Sistemas de IA', status: 'Em revisão' },
                    ...
                    {documents.map(doc => (
                        ...
                        >
                            <div className="trail-doc-info">
                                <div className={`trail-file-icon ${doc.title.endsWith('.pdf') ? 'type-pdf-bg type-pdf-text' : 'type-csv-bg type-csv-text'}`}>
                            ...
                            <div>
                                <span className={`doc-status ${getStatusBadgeClass(doc.status)}`}>{doc.status}</span>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="trail-details-section">
                    <div className="trail-details-banner">
                        <div className="trail-doc-info">
                            ...
                            <div>
                                <span className="trail-doc-name" style={{ fontSize: '16px' }}>Metodologia_Qualitativa_v3.pdf</span>
                                <span className="trail-doc-project">Dra. Renata Silva - Análise LGPD - 7 eventos · 4 versões</span>
                            </div>
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                            <span className="doc-status status-approved"><i className="bi bi-check-circle me-1"></i> Aprovado</span>
                        ...
                        <div className="timeline-card">
                            ...
                            <div className="timeline-container">
                                ...
                                <div className="timeline-event">
                                    <div className="timeline-icon success"><i className="bi bi-check-circle"></i></div>
                                    <div className="timeline-content">
                                        <div className="timeline-text">
                                            <span className="timeline-event-title">Documento aprovado</span>
                                            <span className="timeline-event-meta">Prof. Dr. Faria · Hoje · 14:32 · <span className="timeline-event-hash">#a34fe9d</span></span>
                                        </div>
                                        <div className="timeline-version-tag"><i className="bi bi-diagram-3 me-1"></i> v4</div>
                                    </div>
                                </div>

                                {/* Event 2 */}
                                <div className="timeline-event">
                                    <div className="timeline-icon success"><i className="bi bi-shield-check"></i></div>
                                    <div className="timeline-content">
                                        <div className="timeline-text">
                                            <span className="timeline-event-title">Verificação LGPD aprovada</span>
                                            <span className="timeline-event-meta">Sistema · Hoje · 14:10 · <span className="timeline-event-hash">#7c4dff1</span></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Event 3 */}
                                <div className="timeline-event">
                                    <div className="timeline-icon info"><i className="bi bi-dash-circle"></i></div>
                                    <div className="timeline-content">
                                        <div className="timeline-text">
                                            <span className="timeline-event-title">Nova versão criada</span>
                                            <span className="timeline-event-meta">Dra. Renata Silva · Hoje · 11:48 · <span className="timeline-event-hash">#6a1b9a2</span></span>
                                        </div>
                                        <div className="timeline-version-tag"><i className="bi bi-diagram-3 me-1"></i> v4</div>
                                    </div>
                                </div>
                                ...
                                {/* Event 4 */}
                                <div className="timeline-event">
                                    <div className="timeline-icon warning"><i className="bi bi-chat-left-text"></i></div>
                                    <div className="timeline-content">
                                        <div className="timeline-text">
                                            <span className="timeline-event-title">Comentário do orientador</span>
                                            <span className="timeline-event-meta">Prof. Dr. Faria · Ontem · 16:20 · <span className="timeline-event-hash">#ff91003</span></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Event 5 */}
                                <div className="timeline-event">
                                    <div className="timeline-icon danger"><i className="bi bi-exclamation-circle"></i></div>
                                    <div className="timeline-content">
                                        <div className="timeline-text">
                                            <span className="timeline-event-title">Risco de conformidade sinalizado</span>
                                            <span className="timeline-event-meta">Verificação automática · Ontem · 09:15 · <span className="timeline-event-hash">#c628284</span></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="timeline-event">
                                    ...
                                    <div className="timeline-content">
                                        <div className="timeline-text">
                                            ...
                                            <span className="timeline-event-meta">Dra. Renata Silva · 10 Jun · 09:00 · <span className="timeline-event-hash">#1565c05</span></span>
                                        </div>
                                        <div className="timeline-version-tag"><i className="bi bi-diagram-3 me-1"></i> v3</div>
                                    </div>
                                </div>

                                {/* Event 7 */}
                                <div className="timeline-event">
                                    <div className="timeline-icon purple"><i className="bi bi-upload"></i></div>
                                    <div className="timeline-content">
                                        <div className="timeline-text">
                                            <span className="timeline-event-title">Documento criado</span>
                                            <span className="timeline-event-meta">Dra. Renata Silva · 05 Jun · 10:30 · <span className="timeline-event-hash">#4a148c6</span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="trail-sidebar-card">
                                ...
                                <div className="version-list mt-3">
                                    <div className="version-item">
                                        ...
                                        <span className="doc-status status-approved" style={{ fontSize: '10px', padding: '2px 8px' }}>Aprovado</span>
                                    </div>
                                    <div className="version-item">
                                        <div className="version-info">
                                            <span className="version-tag" style={{ color: 'var(--ed-text-muted)' }}>v3</span>
                                            <span className="version-author">10 Jun - R. Silva</span>
                                        </div>
                                        <span className="doc-status status-draft" style={{ fontSize: '10px', padding: '2px 8px' }}>Substituído</span>
                                    </div>
                                    <div className="version-item">
                                        <div className="version-info">
                                            <span className="version-tag" style={{ color: 'var(--ed-text-muted)' }}>v2</span>
                                    ...
                                    <div className="version-item">
                                        <div className="version-info">
                                            <span className="version-tag" style={{ color: 'var(--ed-text-muted)' }}>v1</span>
