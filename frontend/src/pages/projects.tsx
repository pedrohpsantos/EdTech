...
export default function Projects() {
  ...
  const handleJoin = async (projectId: string) => {
    ...
    if (resp.sucesso) {
      ...
      showToast(
        alreadyJoined ? 'Você já está associado a este projeto.' : 'Erro: ' + resp.mensagem,
      );
    }
  };
  ...
  return (
    <DashboardLayout
      ...
      subtitle={
        canJoinProjects
          ? 'Descubra e associe-se a projetos de pesquisa ativos'
          : 'Acompanhe os projetos sob sua orientação'
      }
    ...
    >
      <div className="dashboard-card p-4">
        ...
        {loading ? (
          <div style={{ padding: '2rem', textAlign: 'center', color: 'var(--ed-text-muted)' }}>
            Carregando projetos...
          </div>
        ) : projects.length === 0 ? (
          <div style={{ padding: '2rem', textAlign: 'center', color: 'var(--ed-text-muted)' }}>
              ...
              >
                ...
                >
                  <button
                    ...
                    onClick={() =>
                      canJoinProjects ? handleJoin(project.id) : navigate('/submissions')
                    }
                    style={{
                      width: '100%',
                      ...
                      opacity: canJoinProjects && project.member ? 0.72 : 1,
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      gap: '8px',
                    ...
                    onMouseOver={(e) =>
                      (e.currentTarget.style.background = 'var(--ed-purple-dark)')
                    }
        ...
        {totalPages > 1 && (
          ...
          >
            ...
            <span style={{ color: 'var(--ed-text-dark)' }}>
