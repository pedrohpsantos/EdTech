        ...
        <div className={styles.kpiGrid}>
          <div className={styles.kpiCard}>
            ...
            <div className={styles.kpiBody}>
              ...
              <span className={`${styles.kpiTrend} ${styles.positive}`}>{chartData.areaChart.trend}</span>
            </div>
          </div>
          ...
          <div className={styles.kpiCard}>
            ...
            <div className={styles.kpiBody}>
              ...
              <span className={`${styles.kpiTrend} ${styles.positive}`}>{chartData.lineChart.trend}</span>
            </div>
          </div>
        ...
        <div className={styles.chartsGrid}>
          ...
          <div className={styles.chartCard}>
            ...
            <svg className={styles.svgChart} viewBox="0 0 400 150" preserveAspectRatio="none">
              ...
              {/* X Axis Labels */}
              <text x="0" y="170" className={styles.svgAxisText}>{chartData.labels[0]}</text>
              <text x="80" y="170" className={styles.svgAxisText}>{chartData.labels[1]}</text>
              <text x="160" y="170" className={styles.svgAxisText}>{chartData.labels[2]}</text>
              <text x="240" y="170" className={styles.svgAxisText}>{chartData.labels[3]}</text>
              <text x="320" y="170" className={styles.svgAxisText}>{chartData.labels[4]}</text>
              <text x="385" y="170" className={styles.svgAxisText}>{chartData.labels[5]}</text>
          ...
          <div className={styles.chartCard}>
            ...
            <svg className={styles.svgChart} viewBox="0 0 400 150" preserveAspectRatio="none">
              ...
              <g className={styles.animateDrawDots}>
                {chartData.labels[0] && <circle cx="0" cy={chartData.lineChart.dots[0]} r="4" fill="var(--ed-orange)" style={{ transition: 'cy 0.5s ease' }} />}
                {chartData.labels[1] && <circle cx="80" cy={chartData.lineChart.dots[1]} r="4" fill="var(--ed-orange)" style={{ transition: 'cy 0.5s ease' }} />}
                {chartData.labels[2] && <circle cx="160" cy={chartData.lineChart.dots[2]} r="4" fill="var(--ed-orange)" style={{ transition: 'cy 0.5s ease' }} />}
                {chartData.labels[3] && <circle cx="240" cy={chartData.lineChart.dots[3]} r="4" fill="var(--ed-orange)" style={{ transition: 'cy 0.5s ease' }} />}
                {chartData.labels[4] && <circle cx="320" cy={chartData.lineChart.dots[4]} r="4" fill="var(--ed-orange)" style={{ transition: 'cy 0.5s ease' }} />}
                {chartData.labels[5] && <circle cx="400" cy={chartData.lineChart.dots[5]} r="4" fill="var(--ed-orange)" style={{ transition: 'cy 0.5s ease' }} />}
              </g>
            </svg>
          </div>
