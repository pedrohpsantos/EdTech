            ...
            >
                ...
                <div className={styles.leftContent}>
                    ...
                    <h1 className={styles.headline}>
                        Junte-se à <br />
                        <span className={styles.headlineLight}>Governança <br />Acadêmica</span>
                    </h1>
                    <p className={styles.subheadline}>
                        Dê o primeiro passo para garantir rastreabilidade e compliance para todo o ciclo de vida dos seus documentos de pesquisa.
                    </p>
                </div>
                ...
                <div className={styles.statsGlass}>
                    <div className={styles.statItem}>
                        ...
                        <span className={styles.statLabel}>Documentos Protegidos</span>
                    </div>
                    <div className={styles.statItem}>
                        <span className={styles.statValue}>347</span>
                        <span className={styles.statLabel}>Pesquisadores Ativos</span>
                    </div>
                </div>
            </motion.div>
            ...
            >
                <div className={styles.formContainer}>
                    <motion.div variants={itemVariants} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <h4 className={styles.acessoLabel}>Novo Cadastro</h4>
                        <ThemeToggle />
                    </motion.div>
                    ...
                    <motion.p variants={itemVariants} className={styles.welcomeSub}>
                        Junte-se à principal plataforma de governança acadêmica.
                    </motion.p>
                    ...
                    >
                        ...
                        <motion.p variants={itemVariants} style={{ fontSize: '0.7rem', color: 'var(--text)', marginTop: '-0.5rem', marginBottom: '1rem' }}>
                        ...
                        <motion.p variants={itemVariants} style={{ textAlign: 'center', margin: '1.5rem 0 0 0', fontSize: '0.875rem' }}>
                            Já tem uma conta? <Link to="/login" className={styles.forgotLink}>Faça login</Link>
                        </motion.p>
                    </form>
                </div>
            </motion.div>
