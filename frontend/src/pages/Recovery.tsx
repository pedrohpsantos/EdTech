...
function Recovery() {
    ...
    const title = step === 1 ? "Esqueceu a senha?" : step === 2 ? "Verificação de Código" : "Nova Senha"
    const subtitle = step === 1 ? "Informe seu e-mail para receber um código de segurança." : step === 2 ? `Enviamos um código de 6 dígitos para ${email}` : "Crie uma nova senha forte para sua conta."
