...
Locator: locator('text=/inválido|invalida|incorreta/i').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/inválido|invalida|incorreta/i').first()
...
```ts
  ...
  73 |     const errorMessage = page.locator('text=/inválido|invalida|incorreta/i');
