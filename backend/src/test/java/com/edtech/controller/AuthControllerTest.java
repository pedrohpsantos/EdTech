...
class AuthControllerTest {
    ...
    @MockitoBean
    private com.edtech.service.TwoFactorAuthService twoFactorAuthService;
    ...
    void loginReturnsTokenInBody() throws Exception {
        ...
        mockMvc
                ...
                .andExpect(
                        org.springframework.test.web.servlet.result.MockMvcResultMatchers.header().exists("Set-Cookie"))
