...
class AuditControllerTest {
    ...
    void getAuditLogs_WithoutFilters_ReturnsAllMappedLogs() {
        ...
        ResponseEntity<Page<AuditLogDto>> response = auditController.getAuditLogs(null, null, null, null,
                PageRequest.of(0, 20));
    ...
    void getAuditLogs_WithSearchFilter() {
        ...
        ResponseEntity<Page<AuditLogDto>> response = auditController.getAuditLogs("specific search", null, null, null,
                PageRequest.of(0, 20));
    ...
    void getAuditLogs_WithActionFilter() {
        ...
        ResponseEntity<Page<AuditLogDto>> response = auditController.getAuditLogs(null, "LOGIN_FAILED", null, null,
                PageRequest.of(0, 20));
