...
public class ProjectServiceTest {
    ...
    void createProject_WithValidData_ReturnsProjectDto() {
        ...
        verify(projectMemberRepository)
                .save(
                        argThat(
                                member -> member.getRole() == ProjectRole.ADVISOR && member.getUser().equals(advisor)));
    }
    ...
    void listProjectsByUser_ReturnsList() {
        ...
        org.springframework.data.domain.Page<ProjectResponseDto> list = projectService.listProjectsByUser(userId,
                PageRequest.of(0, 20));
    ...
    void addMember_Success_SelfAdd() {
        ...
        verify(projectMemberRepository)
                .save(
                        argThat(
                                member -> member.getRole() == ProjectRole.RESEARCHER
    ...
    void addMember_WithNullUserIdInDto_DefaultsToAuthUserId() {
        ...
        verify(projectMemberRepository)
                .save(
                        argThat(
                                member -> member.getRole() == ProjectRole.ADVISOR
                                        && member.getUser().getId().equals(userId)));
    }
