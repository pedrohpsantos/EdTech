...
public class ComplianceController {
  ...
  public ResponseEntity<ComplianceStatsDto> getComplianceStats(Authentication authentication) {
    ...
    p3.setName("Versionamento e cadeia de custÃ³dia");
    ...
    p4.setName("RetenÃ§Ã£o e descarte de dados");
    ...
    p5.setName("AprovaÃ§Ã£o do comitÃª de Ã©tica");
